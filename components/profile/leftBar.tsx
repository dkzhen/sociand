...
export default function LeftBar() {
  ...
  return (
    <>
      <aside
        className={`px-6 md:px-5 md:pr-16 lg:px-10 lg:pr-32 py-8 mt-20 hidden items-center lg:ml-10 ml-5 md:flex flex-col space-y-12 font-poppins border-r lg:mr-4`}
      >
        <Link
          href={"notification"}
          id="notification"
