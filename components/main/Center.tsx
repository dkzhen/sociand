...
export default function Center() {
  ...
  return (
    <main className="lg:px-28 px-3 flex flex-col py-8 mt-10 md:mb-0 mb-10 md:mt-20 ">
      ...
      >
        <div className="flex flex-row items-center p-5 space-x-5">
          <Image
      ...
      {datas.map((item) => (
        <section
          key={item.id}
          id="posts"
          className="flex flex-col border rounded-lg my-5 p-5 bg-primary"
        >
      ...
      {/* <section id="posts" className="flex flex-col border rounded-lg my-5 p-5">
        <h1 className="flex flex-row items-center gap-3">
          <Image
            className="w-14 h-14 rounded-full"
            src={avatarImg}
          ...
          />
          <div className="flex flex-col">
            <p className="font-poppins text-xl">Dani Kurniawan</p>
            <time className="font-poppins text-sm">02/03/2023</time>
          </div>
        </h1>
        <div className="py-3">
          Lorem, ipsum dolor sit amet consectetur adipisicing elit. Animi
          laborum velit sint eius fugit facilis nobis recusandae eveniet quidem
          quo et dolorem soluta, ratione distinctio autem! Vero eligendi
          deleniti distinctio?
        </div>
        <div>
          <Image className="rounded-md" src={postImage1} alt="post-1" />
